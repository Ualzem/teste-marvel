...
<html>
  <head>
    ...
    <title>Teste Marvel - Criador</title>
  ...
  <body onload="comicCreator()" class="comic-creator__body">
    <div class="jumbotron">
          ...
          <div class="d-flex align-items-center container" id="comicCreatorSpinnerSection">
          </div>
          <div class="d-flex align-items-center container" id="comicCreatorSpinnerSection1">
          </div>
